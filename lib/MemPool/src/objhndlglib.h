...
#include <vector>
template<class T>
  class tPM_vector:public std::vector<T, MyLib::MyAlloc<T> >
  {
  };
#else
typedef std::string tPM_string;
